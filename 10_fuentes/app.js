...
(() => {
  ...
  function renderGlosario() {
    const sections = [
      {
        title: "Conceptos metodológicos",
        subtitle: "Cómo se produce y evalúa la evidencia científica",
        terms: [
          { term: "Meta-análisis", def: "Método estadístico que combina resultados de múltiples estudios independientes para estimar un efecto global con mayor precisión.", url: "https://es.wikipedia.org/wiki/Metaan%C3%A1lisis" },
          { term: "Cohorte longitudinal", def: "Diseño de estudio que sigue a un grupo de personas durante años para observar cómo cambian ciertas variables en el tiempo.", url: "https://es.wikipedia.org/wiki/Estudio_de_cohorte" },
          ...
          { term: "Certeza de la evidencia: alta / media / baja", def: "Clasificación usada en este sitio: alta = meta-análisis o cohortes grandes replicadas; media = longitudinales con limitaciones; baja = transversales pequeños o preliminares.", url: "https://es.wikipedia.org/wiki/Medicina_basada_en_evidencia" }
        ]
      },
      {
        title: "Desarrollo infantil",
        subtitle: "Conceptos del desarrollo humano relevantes para interpretar la evidencia",
        terms: [
          { term: "Función ejecutiva", def: "Procesos mentales que permiten planificar, inhibir impulsos, sostener atención y cambiar de tarea. Predictor robusto de logros académicos.", url: "https://es.wikipedia.org/wiki/Funci%C3%B3n_ejecutiva" },
          { term: "Apego seguro", def: "Vínculo estable entre el niño y su cuidador, caracterizado por confianza y disponibilidad emocional; base del desarrollo socioemocional.", url: "https://es.wikipedia.org/wiki/Teor%C3%ADa_del_apego" },
          ...
          { term: "Andamiaje del desarrollo", def: "Relación de dependencia entre habilidades: algunas capacidades tempranas son prerequisito para el desarrollo de capacidades posteriores.", url: "https://es.wikipedia.org/wiki/Zona_de_desarrollo_pr%C3%B3ximo" },
          { term: "Miopía", def: "Trastorno refractivo en que los objetos lejanos se ven borrosos; su prevalencia ha aumentado globalmente, con evidencia asociada al tiempo en interiores.", url: "https://es.wikipedia.org/wiki/Miop%C3%ADa" },
          ...
          { term: "Displasia del desarrollo", def: "Alteración en el ritmo o secuencia del desarrollo esperado para la edad; puede afectar lenguaje, motricidad, cognición o área socioemocional.", url: "https://es.wikipedia.org/wiki/Trastorno_del_desarrollo" }
        ]
      },
      {
        title: "Pantallas y crianza",
        subtitle: "Conceptos específicos del campo de investigación sobre pantallas en la infancia",
        terms: [
          { term: "Technoference", def: "Interferencia del uso de dispositivos digitales del cuidador en la interacción cara a cara con el niño.", url: "https://en.wikipedia.org/wiki/Technoference" },
          { term: "Video deficit", def: "Fenómeno por el cual los niños menores de 3 años aprenden significativamente menos de contenido en pantalla que de la misma información presentada en persona.", url: "https://en.wikipedia.org/wiki/Video_deficit_effect" },
          { term: "TV de fondo", def: "Televisión encendida en el hogar sin ser el foco de atención del niño; reduce la cantidad y calidad del habla dirigida al niño.", url: "https://en.wikipedia.org/wiki/Background_television" },
          { term: "Fast-paced content", def: "Contenido con cambios visuales y auditivos muy rápidos; se asocia con menor capacidad atencional en preescolares.", url: "https://en.wikipedia.org/wiki/Attention_and_media" },
          { term: "Tiempo de pantalla recreativa", def: "Uso de dispositivos digitales con fines de entretenimiento, sin mediación adulta ni propósito educativo explícito.", url: "https://es.wikipedia.org/wiki/Tiempo_de_pantalla" },
          { term: "Co-visionado contingente", def: "Ver pantallas junto al niño con interacción activa y responsiva del adulto; mitiga efectos negativos del contenido pasivo.", url: "https://es.wikipedia.org/wiki/Mediaci%C3%B3n_parental_de_medios" },
          ...
          { term: "PDER (Parental Digital Emotion Regulation)", def: "Uso del dispositivo digital por parte del cuidador para calmar o distraer al niño ante emociones difíciles.", url: "https://doi.org/10.1016/j.chb.2021.106866" },
          { term: "Las 5 Cs (AAP 2026)", def: "Marco de la Academia Americana de Pediatría: Child, Content, Context, Caregiver, Crown (tiempo). Reemplaza la regla de tiempo de pantalla por criterios cualitativos.", url: "https://publications.aap.org/pediatrics/article/157/1/e2025071223/" }
        ]
      }
    ];
