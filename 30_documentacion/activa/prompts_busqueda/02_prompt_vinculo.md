# Prompt de búsqueda bibliográfica — Vínculo y apego × pantallas en niños de 0 a 12 años
...
## DIMENSIÓN ESPECÍFICA: VÍNCULO Y APEGO (`vinculo`)

Buscar evidencia científica reciente (2020-2026) sobre el impacto del uso de pantallas en el vínculo parento-filial y la calidad del apego en niños de 0 a 12 años. (NOTA: esta dimensión enfoca específicamente la relación adulto-niño, no la del niño con pares.)

### Sub-temas a cubrir

1. **Tecnoferencia parental.** Uso del smartphone por el cuidador durante interacciones con el niño; efecto sobre calidad del intercambio.
2. **Still-face paradigm con pantalla.** Estudios experimentales donde el padre/madre dirige atención al teléfono y se mide la respuesta del bebé.
3. **Co-viewing y mediación activa.** Cuándo el uso conjunto fortalece vs. cuándo es solo presencia compartida sin interacción.
4. **Apego seguro vs. inseguro** y patrones de uso parental.
5. **Sensibilidad parental.** Capacidad de detectar y responder a señales del niño; cómo el uso de pantalla la disminuye.
6. **Rutinas de cuidado fragmentadas** (alimentación, baño, hora de dormir interrumpidas por pantalla del cuidador).
7. **Pantalla como sustituto vincular** vs. complemento.
8. **Modelamiento del uso problemático** desde padres con uso intensivo.

### Lo que ya tenemos integrado (no proponer como nuevos)

- **Mallawaarachchi2024**: tributa a vínculo primera infancia.
- **AAP2026**, **AAP2024**: políticas con énfasis en mediación parental.

### Foco específico de novedad

Estamos cortos en:

- Estudios sobre **tecnoferencia paterna** específicamente (la literatura está dominada por estudios sobre madres; el rol paterno está sub-investigado).
- Evidencia para **niñez media y preadolescencia** (la mayoría de estudios vínculo-pantalla se concentra en bebés y toddlers; la relación cambia en escolares).
- Estudios con **mediciones observacionales objetivas** (codificación de video de interacciones), no solo cuestionarios.
- Evidencia sobre **comunicación parental sobre pantallas** (negociación de reglas, conversaciones explícitas) como factor protector.
- Diferencias por **estructura familiar** (monoparental, parejas separadas con dispositivos en cada hogar, cuidadores múltiples).
- Estudios sobre **cómo videocalls con familia lejana** (abuelos, padres en el extranjero) funcionan vincularmente — una práctica cotidiana con poca evidencia formal.
...
**Tributa a la dimensión `vinculo`, tramos etarios:**
