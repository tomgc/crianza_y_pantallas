# Prompt de búsqueda bibliográfica — Cyberbullying y violencia entre pares × pantallas en niños de 0 a 12 años
...
## DIMENSIÓN ESPECÍFICA: CYBERBULLYING Y VIOLENCIA ENTRE PARES (`cyberbullying`)

Buscar evidencia científica reciente (2020-2026) sobre cyberbullying y otras formas de agresión digital entre pares en niños de 0 a 12 años: prevalencia de victimización y perpetración, factores de riesgo y protección, desenlaces en salud mental, y eficacia de intervenciones.

**Nota conceptual importante:** esta dimensión es **distinta de `privacidad`** (que cubre abuso por adultos: grooming, sextorsión) y de `salud-mental` (que cubre desenlaces clínicos internalizantes). El foco aquí es la **agresión horizontal entre pares**: víctima y agresor tienen edad similar. Los claims deben reflejar prevalencia, factores diferenciales respecto al bullying tradicional, y vías de impacto en el desarrollo.

**Nota sobre el rango etario:** la mayoría de la literatura de cyberbullying se concentra en adolescentes (13+). Para este corpus centrado en 0-12, priorizar evidencia de preadolescencia (9-12) y niñez media (6-8) cuando exista. Si la mejor evidencia disponible cubre 10-14 años (solapando con preadolescencia), incluirla con bandera explícita de extrapolación.

### Sub-temas a cubrir

1. **Prevalencia de cyberbullying en preadolescentes.** Tasas de victimización y perpetración en 9-12 años; comparación con bullying tradicional; tendencias temporales (pre vs. post-pandemia).
2. **Factores de riesgo individuales.** Género, edad, habilidades socioemocionales, uso problemático de pantallas como predictor de victimización o perpetración.
3. **Factores de riesgo del entorno.** Supervisión parental digital, clima escolar, acceso a dispositivos propios como moderadores.
4. **Desenlaces en salud mental.** Asociación con depresión, ansiedad, ideación suicida en niñez media y preadolescencia; magnitud del efecto vs. bullying tradicional.
5. **Relación bidireccional bullying-cyberbullying.** Evidencia de que víctimas de bullying presencial son más vulnerables al cyberbullying y viceversa; importancia de intervenir en ambos contextos.
6. **Eficacia de intervenciones.** Programas escolares anti-cyberbullying; eficacia de intervenciones con cuidadores; rol de las plataformas (moderación de contenido, herramientas de reporte).
7. **Perpetración y bystanders.** Factores que predicen que un niño se convierta en agresor o en espectador pasivo; intervenciones para activar bystanders positivos.

### Lo que ya tenemos integrado (no proponer como nuevos)

Los siguientes papers del corpus pueden tener solapamiento parcial — no los propongas como nuevos:

- **Sticca2025**: ya tributa a dimensión socioemocional con evidencia de pares.
- **Ophir2023**: asociación pantalla-autismo en contexto social (JAMA, N=562.131).

### Anchors verificados del prompt 11 (semillas de búsqueda)

Este paper tiene DOI/PMID verificado y debe incluirse:

- **Li et al. 2024** — meta-análisis, European Child & Adolescent Psychiatry. 42 estudios, 266.888 participantes. Tasa media de victimización por cyberbullying: 11,10% (IC95% 9,12–13,44%). DOI: 10.1007/s00787-022-02128-x (PMID 36585978).

### Foco específico de novedad

Estamos particularmente cortos en:

- Evidencia específica de **niñez media (6-8 años)**: ¿existe cyberbullying a estas edades o es un fenómeno que emerge con el acceso a dispositivos propios (9-12)?
- **Intervenciones con evidencia en primaria** (no solo secundaria): programas con seguimiento y medición de victimización real, no solo conocimiento declarado.
- **Evidencia latinoamericana**: prevalencia y factores de riesgo en contexto chileno o regional.
- Distinción entre **cyberbullying en plataformas abiertas** (redes sociales) y **en entornos cerrados** (grupos de WhatsApp, chats de videojuegos): factores de riesgo diferenciales.
...
**Tributa a la dimensión `cyberbullying`, tramos etarios:**
