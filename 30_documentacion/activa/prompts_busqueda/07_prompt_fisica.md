# Prompt de búsqueda bibliográfica — Actividad física y motricidad × pantallas en niños de 0 a 12 años
...
## DIMENSIÓN ESPECÍFICA: ACTIVIDAD FÍSICA Y MOTRICIDAD (`fisica`)

Buscar evidencia científica reciente (2020-2026) sobre el impacto del uso de pantallas en actividad física, motricidad gruesa y motricidad fina en niños de 0 a 12 años.

### Sub-temas a cubrir

1. **Sedentarismo.** Minutos sedentarios diarios atribuibles a pantallas; desplazamiento de juego activo.
2. **Cumplimiento de guías OMS** de actividad física infantil (180 minutos diarios en 1-4 años, 60 minutos moderados-vigorosos en 5-17 años).
3. **Motricidad gruesa.** Coordinación, equilibrio, fuerza, habilidades locomotoras (correr, saltar, lanzar).
4. **Motricidad fina y grafomotricidad.** Destreza manual, coordinación óculo-manual, preparación para lectoescritura.
5. **Obesidad infantil** como desenlace asociado, incluyendo el papel del marketing alimentario en pantallas (overlap con dimensión potencial nueva, ver Prompt 11).
6. **Postura, columna y musculoesquelético:** "text neck", sobrecarga de cuello/hombros en niños usuarios intensivos de smartphone.
7. **Exergaming** (videojuegos con movimiento, Nintendo Switch Sports tipo): ¿son sustitutos parciales de actividad física?

### Lo que ya tenemos integrado (no proponer como nuevos)

- **Bakht2025** (Pediatric Discovery): revisión sistemática motor 0-7 años, 24 estudios.
- **AguilarFarias2021**: estudio chileno pandemia, datos cuantitativos.
- **Pearson2018**: sedentarismo longitudinal.

### Foco específico de novedad

Estamos cortos en:

- Evidencia para **niñez media y preadolescencia** (6-12 años) sobre motricidad y pantallas (la literatura motor se concentra en menores).
- Estudios sobre **postura, musculoesquelético y "text neck"** con evidencia 2020+ (es un campo emergente).
- Evidencia sobre **exergaming y juegos activos** y su efectividad real como reemplazo de actividad física tradicional.
- Estudios latinoamericanos post-pandemia sobre actividad física pediátrica y pantallas.
- Magnitudes cuantificadas del desplazamiento: ¿cuántos minutos de actividad se pierden por cada hora de pantalla?
...
**Tributa a la dimensión `fisica`, tramos etarios:**
