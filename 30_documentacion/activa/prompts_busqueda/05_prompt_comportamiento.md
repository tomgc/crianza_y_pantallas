# Prompt de búsqueda bibliográfica — Comportamiento y autorregulación × pantallas en niños de 0 a 12 años
...
## DIMENSIÓN ESPECÍFICA: COMPORTAMIENTO Y AUTORREGULACIÓN (`comportamiento`)

Buscar evidencia científica reciente (2020-2026) sobre el impacto del uso de pantallas en comportamiento y autorregulación en niños de 0 a 12 años. (NOTA: esta dimensión cubre síntomas externalizantes (impulsividad, agresión, oposicionalismo), autorregulación (capacidad de modular respuestas emocionales y conductuales), y problemas conductuales clínicos. Distinta de `salud-mental` (internalizantes, clínica), `cognicion` (funciones ejecutivas como capacidad), y `socioemocional` (competencias relacionales).)

### Sub-temas a cubrir

1. **Síntomas externalizantes:** agresión, impulsividad, oposicionalismo, conducta disruptiva.
2. **Autorregulación emocional.** Capacidad de manejar frustración, tolerancia a esperar, transición entre actividades.
3. **Pantalla como herramienta de regulación parental ("niñera electrónica").** Efecto sobre el desarrollo de autorregulación propia del niño.
4. **Rabietas y desregulación inmediata post-pantalla.** La transición pantalla → no pantalla; mecanismos.
5. **Contenido fast-paced y autorregulación.** Hipótesis de que el ritmo del contenido entrena el sistema dopaminérgico hacia recompensas rápidas.
6. **Uso problemático y conducta compulsiva** en preadolescentes (precursores de problemas de uso en adolescencia).
7. **TDAH-like behaviors** (overlap con cognición/atención; aquí enfocar en componente conductual).

### Lo que ya tenemos integrado (no proponer como nuevos)

- **Eirich2022**: tributa también a comportamiento.
- **Mallawaarachchi2024**: en comportamiento-primera-infancia.
- **LlanosMerin2024**: en comportamiento-preescolar.
- **MINEDUC2026**: regulación escolar.

### Foco específico de novedad

Estamos cortos en:

- Estudios sobre **autorregulación parental modelada** (cómo el uso parental de pantallas afecta la autorregulación del hijo, vía modelamiento).
- Evidencia experimental (no solo correlacional) sobre el efecto del contenido fast-paced en autorregulación inmediata. (Hay estudios Lillard sobre SpongeBob de la década 2010; buscar replicaciones recientes.)
- Evidencia para **lactantes** (la dimensión está poco poblada en este tramo).
- Estudios sobre el **rebound emocional** post-pantalla (rabietas en la transición) con métricas objetivas.
- Evidencia sobre **intervenciones** familiares para reducir el uso problemático en menores de 12 años (la literatura de intervención es escasa comparada con la observacional).
...
**Tributa a la dimensión `comportamiento`, tramos etarios:**
